...
var includesPath = '/helperpages/';
var cssFile = '/stylesheets/rte.css';
...
function initRTE(imgPath, incPath, css) {
	...
	if (isRichText) document.writeln('<style type="text/css">@import "/stylesheets/rte.css";</style>');
...
function updateRTE(rte) {
	...
	//Sal added this to escape everything before going to the database
